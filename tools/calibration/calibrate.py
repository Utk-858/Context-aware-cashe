...
def main():
    ...
    print(f"{'Threshold':<10} | {'TP':<4} | {'FP':<4} | {'TN':<4} | {'FN':<4} | {'Precision':<9} | {'Recall':<9} | {'F1-Score':<8}")
    print("-" * 72)
    ...
    for th in thresholds:
        ...
        print(f"{th:<10.2f} | {tp:<4} | {fp:<4} | {tn:<4} | {fn:<4} | {precision:<9.4f} | {recall:<9.4f} | {f1:<8.4f}")
    ...
    print(f"1. Max F1 Score Threshold: {max_f1_item['threshold']:.2f} (F1={max_f1_item['f1_score']:.4f}, Precision={max_f1_item['precision']:.4f}, Recall={max_f1_item['recall']:.4f})")
    print(f"2. Safety-First Threshold : {safety_item['threshold']:.2f} (Precision={safety_item['precision']:.4f}, Recall={safety_item['recall']:.4f})")
    print(f"3. Balanced Threshold     : {balanced_item['threshold']:.2f} (F1={balanced_item['f1_score']:.4f}, Precision={balanced_item['precision']:.4f}, Recall={balanced_item['recall']:.4f})")
    ...
    report_data = {
        ...
        "distributions": {
            "positive_matches": pos_stats,
            "negative_matches": neg_stats
        },
        ...
        "recommendations": {
            "max_f1": {
                ...
                "confusion_matrix": {"tp": max_f1_item["tp"], "fp": max_f1_item["fp"], "tn": max_f1_item["tn"], "fn": max_f1_item["fn"]}
            },
            "safety_first": {
                ...
                "confusion_matrix": {"tp": safety_item["tp"], "fp": safety_item["fp"], "tn": safety_item["tn"], "fn": safety_item["fn"]}
            },
            "balanced": {
                ...
                "confusion_matrix": {"tp": balanced_item["tp"], "fp": balanced_item["fp"], "tn": balanced_item["tn"], "fn": balanced_item["fn"]}
            }
        }
    }
